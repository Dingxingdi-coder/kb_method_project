...
A3 的 stage cap 可以这样设计：

| A3 stage | token cap |
| --- | --- |
| task understanding / constraints | 1.5k |
| implementation strategy | 2.5k |
| optimization knobs | 2.5k |
| failure diagnosis | 2.5k |
| legality / anti-cheating hints | 1k |
| spare / adaptive | 2k |

总上限仍是 12k，但 A3 可以少取。正式报告中要区分：
