...
- run_records: 4
- csv: `artifacts/h20/reports/softmax_4096x1024_pilot_v2_report.csv`
- json: `artifacts/h20/reports/softmax_4096x1024_pilot_v2_report.json`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| A0_no_kb | softmax | 1 | 1 | 1 | 1 | 1.777 | 1 | 2.921 | 0 |
| A1_plain_rag | softmax | 1 | 1 | 1 | 1 | 1.73 | 1 | 2.484 | 0 |
| A2_rulebook | softmax | 1 | 1 | 1 | 1 | 1.722 | 1 | 2.354 | 0 |
| A3_ecc_kb | softmax | 1 | 1 | 1 | 1 | 1.942 | 1 | 2.295 | 0 |
